...
git config --global user.email "<frrrnd-blog-bot>@users.noreply.github.com"
git config --global user.name "frrrnd Blog Bot"
git config --global push.default simple

rm -rf deployment
git clone -b master https://github.com/frrrnd/frrrnd.github.io.git deployment
